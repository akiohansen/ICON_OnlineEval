...
for file in /mnt/lustre02/work/bm0834/k203095/icon-lem-alpha/icon-lem/experiments/hdcp2_final/2d_cloud_*_DOM*_ML_2014*
...
do
    ...
    if [[ $INPUT_FILE == *"DOM01_ML_20130420T"* ]] || [[ $INPUT_FILE == *"DOM01_ML_20130421T"* ]] || [[ $INPUT_FILE == *"DOM01_ML_20130424T"* ]] || [[ $INPUT_FILE == *"DOM01_ML_20130425T"* ]] || [[ $INPUT_FILE == *"DOM01_ML_20130426T"* ]] || [[ $INPUT_FILE == *"DOM01_ML_20130427T"* ]]; then
    	...
    	outputdir="/mnt/lustre02/work/bm0834/u233139/rain_RADOLAN_2CCN/"
    	...
    	outputdir="/mnt/lustre02/work/bm0834/u233139/rain_RADOLAN_2CCN/"
  		#echo "Use grid: "$griddes" with "$gridfile
    elif [[ $INPUT_FILE == *"DOM01_ML_20140814T"* ]]; then
        griddes="/mnt/lustre02/work/bm0834/u233139/griddes/GRID_default_3d_fine_DOM01_ML"
        gridfile="/mnt/lustre02/work/bm0834/k203095/OUTPUT/GRIDS/GRID_default_3d_fine_DOM01_ML.nc"
        outputdir="/mnt/lustre02/work/bm0834/u233139/cloud_RADOLAN_Alpha/"
        #echo "Use grid: "$griddes" with "$gridfile
    	...
    	outputdir="/mnt/lustre02/work/bm0834/u233139/rain_RADOLAN_2CCN/"
  		#echo "Use grid: "$griddes" with "$gridfile
    elif [[ $INPUT_FILE == *"DOM02_ML_20140814T"* ]]; then
        griddes="/mnt/lustre02/work/bm0834/u233139/griddes/GRID_default_3d_fine_DOM02_ML"
        gridfile="/mnt/lustre02/work/bm0834/k203095/OUTPUT/GRIDS/GRID_default_3d_fine_DOM02_ML.nc"
        outputdir="/mnt/lustre02/work/bm0834/u233139/cloud_RADOLAN_Alpha/"
        #echo "Use grid: "$griddes" with "$gridfile
    	...
    	outputdir="/mnt/lustre02/work/bm0834/u233139/rain_RADOLAN_2CCN/"
  		#echo "Use grid: "$griddes" with "$gridfile
    elif [[ $INPUT_FILE == *"DOM03_ML_20140814T"* ]]; then
        griddes="/mnt/lustre02/work/bm0834/u233139/griddes/GRID_default_3d_fine_DOM03_ML"
        gridfile="/mnt/lustre02/work/bm0834/k203095/OUTPUT/GRIDS/GRID_default_3d_fine_DOM03_ML.nc"
        outputdir="/mnt/lustre02/work/bm0834/u233139/cloud_RADOLAN_Alpha/"
        #echo "Use grid: "$griddes" with "$gridfile
	else
    ...
    cdo -timselmean,"$timint" -selvar,clt "$file" "/mnt/lustre02/work/bm0834/u233139/rain_RADOLAN/temp/Extract-Timselmean-"$INPUT_FILE

    # Merge grid with the file for later regridding
    cdo -P 24 -setgrid,$gridfile "/mnt/lustre02/work/bm0834/u233139/rain_RADOLAN/temp/Extract-Timselmean-"$INPUT_FILE "/mnt/lustre02/work/bm0834/u233139/rain_RADOLAN/temp/Extract-Timselmean-Merge-"$INPUT_FILE

    # Remap to latlon grid for final file
    cdo -P 20 -remapdis,$griddes "/mnt/lustre02/work/bm0834/u233139/rain_RADOLAN/temp/Extract-Timselmean-Merge-"$INPUT_FILE $outputdir"Extract-Timselmean-Merge-LL-"$INPUT_FILE
